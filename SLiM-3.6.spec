...
Source0:        https://github.com/MesserLab/SLiM/archive/v3.6.tar.gz
Patch0:         fedora34.patch
...
%prep
tar -xf ../SOURCES/v3.6.tar.gz
patch ./SLiM-3.6/eidos/robin_hood.h < ../SOURCES/fedora34.patch
...
#       id="rect31"
#       style="fill:#000000" />
sed -i '69,166 s/"fill:#[[:alnum:]]*"/"fill:#ffffff"/' ./SLiM-3.6/QtSLiM/icons/AppIcon16.svg
sed -i '62,68 d' ./SLiM-3.6/QtSLiM/icons/AppIcon16.svg

%build
cmake --parallel -DBUILD_SLIMGUI=ON ./SLiM-3.6/
make
...
cp --no-target-directory ./SLiM-3.6/QtSLiM/icons/AppIcon64.svg %{buildroot}/usr/share/icons/hicolor/scalable/apps/org.messerlab.slimgui.svg
cp --no-target-directory ./SLiM-3.6/QtSLiM/icons/AppIcon16.svg %{buildroot}/usr/share/icons/hicolor/symbolic/apps/org.messerlab.slimgui-symbolic.svg

# slim Mimetype Icon
cp --no-target-directory ./SLiM-3.6/QtSLiM/icons/DocIcon.svg %{buildroot}/usr/share/icons/hicolor/scalable/mimetypes/text-slim.svg

# Desktop Entry and Appstream XMLs
cp ./SLiM-3.6/org.messerlab.slimgui-mime.xml --target-directory %{buildroot}/usr/share/mime/packages/
cp ./SLiM-3.6/org.messerlab.slimgui.desktop --target-directory %{buildroot}/usr/share/applications/
cp ./SLiM-3.6/org.messerlab.slimgui.appdata.xml --target-directory %{buildroot}/usr/share/metainfo/
...
%changelog
* Sat Mar 20 2021 Bryce Carson <brycecarson@localhost.localdomain> - 3.6-4
